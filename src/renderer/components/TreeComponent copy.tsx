...
const TreeComponent = forwardRef(function TreeComponent(props, ref) {
  ...
  useImperativeHandle(
    ...
    () => {
      return {
        addNote: () => {
          console.log(`TreeComponent.addNote()`);
        },
      };
    },
    []
    ...
    $domNode.fancytree({
      ...
      click: async (event, data) => {
        ...
        if (data.targetType === 'title') {
          ...
          const note: Note = await nowNoteAPI.getNoteWithDescription(
            data.node.key
          );
